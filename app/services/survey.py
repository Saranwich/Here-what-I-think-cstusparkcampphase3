...
- **เขาเล่าหลายเรื่องในย่านเดียวกัน ให้เก็บลง notes ให้ครบทุกเรื่อง**
  ...
  แล้วเลือก category จากเรื่องที่หนักที่สุด **ห้ามหยิบมาเรื่องเดียวแล้วทิ้งที่เหลือ**
  เขาพิมพ์มาแล้ว จะให้หายไปเฉย ๆ ไม่ได้
- เขาเล่าเรื่องที่คนละที่กันจริง ๆ ก็ยังเก็บลง notes ใบเดียวกัน แต่**เขียนให้ชัดว่าอันไหนอยู่ตรงไหน**
  ทีมออกแบบอ่านออกเองได้ ดีกว่าใบที่แตกเป็นสองใบแล้วได้ครึ่งเดียวทั้งคู่
